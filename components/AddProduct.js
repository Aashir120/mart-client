import { View, Text,StyleSheet, Button, Dropdown,KeyboardAvoidingView,Keyboard,Image, ScrollView, TextInput,TouchableOpacity, Alert } from 'react-native'
...
const AddProduct = ({navigation,max, ...props}) => {

    let productMart = props.route.params;
  ...
  function createProduct(){
    ...
    database().ref(`Mart/${productMart}`).child('Products').child(`${newProduct}`).set({
      Name:newProduct,
      Description:desc,
      Stock:Qty,
      Size:value,
      ...
      behavior='padding'>
         <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{padding:20,justifyContent:'space-around'}} >
            ...
            multiline={true}
            value={props.product} onChangeText={(text)=>props.setProduct(text)} />
